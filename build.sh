...
CLANG_DIR="$TC_DIR/clang-r468909b"
...
if [ -f "$kernel" ] && [ -d "$dts_dir" ]; then
	...
	mkdir AnyKernel3/modules/vendor/lib/modules/5.4.234-NetHunter/
	#cp $(find $OUT_DIR/modules/lib/modules/5.4* -name '*.ko') AnyKernel3/modules/vendor/lib/modules/
	cp out/modules/lib/modules/5.4*/modules.{alias,dep,softdep} AnyKernel3/modules/vendor/lib/modules/5.4.234-NetHunter/
	cp out/modules/lib/modules/5.4*/modules.order AnyKernel3/modules/vendor/lib/modules/5.4.234-NetHunter/modules.load
	cp out/modules/lib/modules/5.4.*/modules.* AnyKernel3/modules/vendor/lib/modules/5.4.234-NetHunter/
	sed -i 's/\(kernel\/[^: ]*\/\)\([^: ]*\.ko\)/\/vendor\/lib\/modules\/\2/g' AnyKernel3/modules/vendor/lib/modules/5.4.234-NetHunter/modules.dep
